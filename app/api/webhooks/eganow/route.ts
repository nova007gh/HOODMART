...
// Eganow POSTs the final transaction status here (configured as the `callback`
// field on the collection request). Payload fields are not fully documented,
// so we defensively read multiple possible field names.
